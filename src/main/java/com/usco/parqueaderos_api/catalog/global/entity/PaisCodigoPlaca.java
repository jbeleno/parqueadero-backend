 ...
 */
@Entity
@Table(name = "pais_codigo_placa")
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class PaisCodigoPlaca extends BaseEntity {
    ...
    @jakarta.persistence.Column(name = "regex_placa", length = 200)
    private String regexPlaca;
