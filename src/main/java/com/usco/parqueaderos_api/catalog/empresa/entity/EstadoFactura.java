 ...
 */
@Entity
@Table(name = "estado_factura", uniqueConstraints = {
    @UniqueConstraint(name = "uq_estadofactura", columnNames = {"empresa_id", "codigo"})
})
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class EstadoFactura extends BaseEntity {
