 ...
 */
@Entity
@Table(name = "tipo_movimiento_caja", uniqueConstraints = {
    @UniqueConstraint(name = "uq_tipomovimientocaja", columnNames = {"empresa_id", "codigo"})
})
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class TipoMovimientoCaja extends BaseEntity {
