 ...
 */
@Entity
@Table(name = "estado_suscripcion", uniqueConstraints = {
    @UniqueConstraint(name = "uq_estadosuscripcion", columnNames = {"empresa_id", "codigo"})
})
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class EstadoSuscripcion extends BaseEntity {
