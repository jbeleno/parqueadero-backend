 ...
 */
@Entity
@Table(name = "empresa_metodo_pago", uniqueConstraints = {
    @UniqueConstraint(name = "uq_empresametodopago", columnNames = {"empresa_id", "codigo"})
})
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class EmpresaMetodoPago extends BaseEntity {
