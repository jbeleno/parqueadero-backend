 ...
 */
@Entity
@Table(name = "origen_factura", uniqueConstraints = {
    @UniqueConstraint(name = "uq_origenfactura", columnNames = {"empresa_id", "codigo"})
})
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class OrigenFactura extends BaseEntity {
