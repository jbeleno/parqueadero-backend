 ...
 */
@Entity
@Table(name = "tipo_movimiento_saldo", uniqueConstraints = {
    @UniqueConstraint(name = "uq_tipomovimientosaldo", columnNames = {"empresa_id", "codigo"})
})
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class TipoMovimientoSaldo extends BaseEntity {
